function next() {
  location.replace("./bonusround.html");
}
...
class leadership extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("background3", "SLICES/game3background_completed.png");
  ...
  create() {
    ...
    var dec = money.toFixed(2);

    let spritetimer = this.add.text(1050, 500, number + " " + sec, {
      font: "32px Roboto",
      fill: "black",
    });
    let spritemoney = this.add.text(1050, 418, dec, {
      font: "32px Roboto",
      fill: "black",
    });
  }
