...
class question4 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("cardmcq2b", "game2/image/LP/2B.jpeg");
    this.load.image("cardmcq2c", "game2/image/LP/2C.jpeg");
...
class question11 extends Phaser.Scene {
  ...
  localStorage.setItem("click", 0);
    ...
    const text1 = this.add.text(
      465,
      245,
      "When I overspend, it is okay to ask my parents for more money.",
      { fontFamily: "Roboto", fill: "black" }
    );
