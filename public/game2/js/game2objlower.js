function ques() {
  location.replace("./game2lower.html");
}
...
class objective extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("background1", "game2/image/game2_intropg.jpg");
  ...
  let music = this.sound.add("backgroundmusic");
    ...
    let sprites1 = this.add.sprite(1820, 770, "start1").setInteractive();
...
class summary extends Phaser.Scene {
  ...
  create() {
    ...
    let hd2 = this.add.sprite(1921 / 2, 30, "header2");
