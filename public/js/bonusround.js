...
class SceneA extends Phaser.Scene {
  ...
  preload() {
    this.load.image("background", "SLICES/bonusround.jpg");
  ...
  create() {
    ...
    //create sprite
    let bg = this.add.sprite(1921 / 2, 400, "background").setScale(1, 1);
...
class SceneB extends Phaser.Scene {
  ...
  preload() {
    this.load.image("titlebackground", "SLICES/createyoursmiley.jpg");
  ...
  let music = this.sound.add("backgroundmusic");
    ...
    //create sprite
    let bg = this.add.sprite(1921 / 2, 400, "titlebackground");
    let top = this.add.sprite(1921 / 2, 30, "top");
    ...
    let spritename = this.add.text(160, 150, playername, {
      font: "32px Arial",
      fill: "white",
    });
