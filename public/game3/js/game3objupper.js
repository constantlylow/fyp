function ques() {
  location.replace("./game3upper.html");
}
...
class summary extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("background_s", "game3/image/game3_lgckpt.jpeg");
...
class objective extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("background1", "game3/image/game3_intropg.jpg");
