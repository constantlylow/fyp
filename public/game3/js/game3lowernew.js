...
class question1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("card1-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp01q.png");
    this.load.image("card1-2","game3/image/game3_flipcards/lowerpri_question-answer/lp01a.png");
    this.load.image("card2-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp02q.png");
    this.load.image("card3-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a10.png");
    this.load.image("card3-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q10.png");
    this.load.image("card3-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp07q.png");
    this.load.image("card4-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp15q.png");
    this.load.image("card5-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp08q.png");
    this.load.image("card2-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp02a.png");
    this.load.image("card4-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp15a.png");
    this.load.image("card5-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp08a.png");
    this.load.image("card3-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp07a.png");
    this.load.image("card2-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp02a.png");
    this.load.image("tick", "SLICES/correct.png");
    this.load.image("card1-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a16.png");
    this.load.image("card1-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q16.png");
    this.load.image("card2-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q15.png");
    this.load.image("card2-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a15.png");
    this.load.image("card4-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a2.png");
    this.load.image("card4-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q2.png");
    this.load.image("card5-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q9.png");
    this.load.image("card5-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a9.png");
  }
...
class question2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("homebtn", "SLICES/new_bttn-previous.png");
    //this.load.image('whiteboard', 'game3/image/placeholder_checkpoint.jpg');
    this.load.image("card6-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp16q.png");
    this.load.image("card6-2","game3/image/game3_flipcards/lowerpri_question-answer/lp16a.png");
    this.load.image("card7-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp04q.png");
    this.load.image("card8-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a8.png");
    this.load.image("card8-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q8.png");
    this.load.image("card8-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp09q.png");
    this.load.image("card9-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp12q.png");
    this.load.image("card10-1", "game3/image/game3_flipcards/lowerpri_question-answer/lp10q.png");
    this.load.image("card7-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp04a.png");
    this.load.image("card9-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp12a.png");
    this.load.image("card10-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp10a.png");
    this.load.image("card8-2", "game3/image/game3_flipcards/lowerpri_question-answer/lp09a.png");
    this.load.image("tick", "SLICES/correct.png");
    this.load.image("card6-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a1.png");
    this.load.image("card6-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q1.png");
    this.load.image("card7-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q13.png");
    this.load.image("card7-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a13.png");
    this.load.image("card9-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a5.png");
    this.load.image("card9-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q5.png");
    this.load.image("card10-11", "game3/image/game3_flipcards/lowerpri_question-answer/low_q7.png");
    this.load.image("card10-22", "game3/image/game3_flipcards/lowerpri_question-answer/low_a7.png");
  }
...
//--------game codes------------
    ...
    spriterb.on('pointerdown', function() {
        window.location.href = "game3ResultLower.html";
    });
