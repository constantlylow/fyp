...
class SceneB extends Phaser.Scene {
  ...
  preload() {
    this.load.image("game1background", "SLICES/GAME 1/needvswant_landinpg.jpeg");
    this.load.image("top", "game2/image/header.png");
    this.load.image("cross", "SLICES/btn_close.png");
...
class SceneC1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("correctans", "SLICES/btn_anscorrect.png");
    this.load.image("wrongans", "SLICES/btn_answrong.png");
  ...
  create() {
    ...
    let correctans = this.add.sprite(750, 620, "correctans").setDepth(1);
    correctans.setVisible(false);
    let wrongans = this.add.sprite(1150, 620, "wrongans").setDepth(1);
...
class SceneC2 extends Phaser.Scene {
  ...
  create() {
    ...
    let correctans = this.add.sprite(1150, 620, "correctans").setDepth(1);
    correctans.setVisible(false);
    let wrongans = this.add.sprite(750, 620, "wrongans").setDepth(1);
    wrongans.setVisible(false);
