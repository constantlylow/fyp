...
class SceneA extends Phaser.Scene {
  ...
  create() {
    ...
    //--------------------------NEXT BUTTON------------------------------
    let spritenextbtn = this.add.sprite(1850, 770, "nextbtn").setInteractive();
...
class SceneB extends Phaser.Scene {
  ...
  create() {
    ...
    var i = 0;
    var playername = sessionStorage.getItem(i);
    let spritename = this.add.text(100, 150, playername, {
      font: "32px Arial",
      fill: "white",
    });
    var playercoin = Number(localStorage.getItem(i));
...
class SceneC1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("worthplaceholder", "SLICES/GAME 1/placeholder_savemore.png");
    this.load.image("lowerqn1need", "SLICES/GAME 1/q1a.png");
    this.load.image("lowerqn1want", "SLICES/GAME 1/q1.png");
  ...
  create() {
    ...
    let worthplaceholder = this.add
      .sprite(1921 / 2, 500, "worthplaceholder")
      .setScale(0.65, 0.65);
    ...
    function startCountdown(seconds) {
      ...
      const interval = setInterval(() => {
        ...
        let ccounter = localStorage.getItem(0);
        document.getElementById("coin").innerHTML = "$" + ccounter;
        if (counter <= 0) {
          clearInterval(interval);
          console.log("Ding!");
          window.location.href = "game1ResultUpper.html";
        }
      }, 1000);
    }
    startCountdown(60);
    ...
    spritepausebtn.on("pointerdown", function () {
      ...
      if (proceed) {
        //proceed
        window.location.href = "game1upper.html";
      }
    });
    ...
    spritenextbtn.on("pointerdown", () => this.scene.start("sceneD1"));

    //--------------------------QN 1 NEED BUTTON CORRECT------------------------------
    let spriteneed1 = this.add
      .sprite(750, 560, "lowerqn1need")
      .setInteractive();
...
//-----------LOWER GAME QUESTION 1-----------------------------
class SceneD1 extends Phaser.Scene {
  constructor() {
    super({ key: "sceneD1" });
  }
  preload() {
    ...
    this.load.image("backbtn", "SLICES/new_bttn-previous.png");
    this.load.image("worthplaceholder", "SLICES/GAME 1/placeholder_savemore.png");
    this.load.image("upperqn2notworth", "SLICES/GAME 1/purchaseshop.png");
    this.load.image("upperqn2worth", "SLICES/GAME 1/watercooler.png");
    this.load.image("correctans", "SLICES/correct.png");
    this.load.image("wrongans", "SLICES/wrong.png");
  }
  create() {
    ...
    //--------------------------QN 1 WANT BUTTON WRONG------------------------------
    let spritewant1 = this.add
      .sprite(1150, 560, "upperqn2notworth")
      .setInteractive();
    spritewant1.setScale(0.65, 0.65);
    spritewant1.on("pointerover", function (event) {
      this.setTint(0xffae00);
...
class SceneC5 extends Phaser.Scene {
  ...
  create() {
    ...
    let spritewant5 = this.add
      ...
      .setInteractive();
    spritewant5.setScale(0.65, 0.65);
